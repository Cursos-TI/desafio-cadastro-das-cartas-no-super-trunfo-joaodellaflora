...
Este projeto implementa um sistema de cadastro de cartas para o jogo Super Trunfo em linguagem C.
...
```bash
gcc sp_trunfo.C -o sp_trunfo
./sp_trunfo
```

## Estrutura do projeto

- `sp_trunfo.C` - Código principal do programa
